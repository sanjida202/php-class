        ...
        <div id="main">
            <div id="login">
                ...
                <form action="" method="post" name="taskForm">
                    ...
                    <textarea name="description" id="description" required="required" ><?php echo $_GET["name"] ?></textarea><br/><br />

                    <label class="general">Completion Date*:</label>
                    <input type="date" name="due_date" id="due_date" required="required" /><br/><br />

                    <label class="general">Status*:</label>
                ...
                <?php require("./edit-task_script.php") ?>
            </div>
        </div>
    </div> 
</div>
